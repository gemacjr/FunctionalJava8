    ...
    private static void lambdaExpressionsRevisited(){
        ...
        list.forEach(new Consumer<String>() {
            ...
            public void accept(String s) {
                System.out.println("Inner Consumer : " + s);
            }
        });

        list.forEach(t -> System.out.println("Plain Foreach : " + t));
        Consumer consumer = t -> System.out.println("Last consumer : " + t);
        list.forEach(consumer);
    }

    private static String processString(Function<String, String> operation, String target){
